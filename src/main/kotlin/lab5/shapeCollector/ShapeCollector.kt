...
//+    Класс должен иметь верхнюю границу в виде типа ColoredShape2d
//+    Добавить метод addAll, который принимает коллекцию фигур и добавляет их в Collector
//+    Добавить метод getSorted, который будет возвращать фигуры в отсортированном виде, а принимать Comparator (kotlin.Comparator)
//?    При необходимости переписать метод возвращения фигур определенного типа
}